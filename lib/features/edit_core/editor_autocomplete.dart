...
class DefaultCodeAutocompleteListView extends StatefulWidget
...
class _DefaultCodeAutocompleteListViewState
    extends State<DefaultCodeAutocompleteListView> {
  @override
  void initState() {
        ...
        child: AutoScrollListView(
          ...
          itemBuilder: (context, index) {
            ...
            final BorderRadius radius = BorderRadius.only(
              ...
              topRight: index == 0 ? const Radius.circular(4) : Radius.zero,
            ...
            return InkWell(
                ...
                child: Container(
                  ...
                  child: RichText(
                    text: prompt.createSpan(
                        context,
                        widget.notifier.value.input,
                        index == widget.notifier.value.index),
...
extension _CodePromptExtension on CodePrompt {
  InlineSpan createSpan(BuildContext context, String input, bool isSelect) {
