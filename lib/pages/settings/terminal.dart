    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _TerminalColorPreview(foreground: foreground, background: background),
...
// const _terminalPreviewPalette = <Color>[
//   Color(0xFF000000),
//   Color(0xFFCD3131),
//   Color(0xFF0DBC79),
//   Color(0xFFE5E510),
      ...
      child: Container(
        ...
        child: RichText(
          text: TextSpan(
            style: terminalStyle,
            children: [
              const TextSpan(text: ">>> print('Pyrite IDE')\n"),
              const TextSpan(text: 'Pyrite IDE'),
            ],
          ),
        ),
      ),
