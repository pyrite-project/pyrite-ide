...
const List<String> itemsLabel = ["首页", "文件", "工具", "设置"];
...
List<Widget> bottomItems = [
  ...
  NavigationDestination(icon: itemsIcons[3], label: itemsLabel[3]),
...
List<NavigationRailDestination> tabletRailItems = [
  ...
  NavigationRailDestination(icon: itemsIcons[3], label: UseText(itemsLabel[3])),
