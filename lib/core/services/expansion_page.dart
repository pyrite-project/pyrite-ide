...
final StateProvider<TabbedViewController>
expansionViewController = StateProvider<TabbedViewController>(
  (ref) {
    ...
    return TabbedViewController([
      TabData(
        ...
        leading: (context, status) => Padding(
          ...
          child: Image.asset("assets/icons/app_icon.webp", width: 15, height: 15),
        ),
      ),
    ]);
  },
