...
class SettingsRegistry {
  static final List<_SettingEntry> _settings = [
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(editorTextFontProvider.notifier).state = v.toString(),
    ),
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(editorFontSize.notifier).state = (v as num).toDouble(),
    ),
    _SettingEntry(
    ...
    _SettingEntry(
      name: 'editor.code_folding',
      type: 'bool',
      provider: editorCodeFolding,
      getter: (ref) => ref.read(editorCodeFolding),
      setter: (ref, v) =>
          ref.read(editorCodeFolding.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'editor.guide_lines',
      type: 'bool',
      provider: editorGuideLines,
      getter: (ref) => ref.read(editorGuideLines),
      setter: (ref, v) => ref.read(editorGuideLines.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'editor.local_suggestions',
      type: 'bool',
      provider: editorLocalSuggestions,
      getter: (ref) => ref.read(editorLocalSuggestions),
      setter: (ref, v) =>
          ref.read(editorLocalSuggestions.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'editor.keyboard_suggestions',
      type: 'bool',
      provider: editorKeyboardSuggestions,
      getter: (ref) => ref.read(editorKeyboardSuggestions),
      setter: (ref, v) =>
          ref.read(editorKeyboardSuggestions.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'editor.use_space_as_tab',
      type: 'bool',
      provider: editorUseSpaceAsTab,
      getter: (ref) => ref.read(editorUseSpaceAsTab),
      setter: (ref, v) =>
          ref.read(editorUseSpaceAsTab.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'editor.tab_size',
      type: 'int',
      provider: editorTabSize,
      getter: (ref) => ref.read(editorTabSize),
      setter: (ref, v) =>
          ref.read(editorTabSize.notifier).state = (v as num).toInt(),
    ),
    _SettingEntry(
      name: 'editor.gutter_divider',
      type: 'bool',
      provider: editorGutterDivider,
      getter: (ref) => ref.read(editorGutterDivider),
      setter: (ref, v) =>
    ...
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(lspStdioExecutable.notifier).state = v.toString(),
    ),
    _SettingEntry(
      name: 'lsp.stdio_args',
      type: 'string',
    ...
    _SettingEntry(
      name: 'lsp.semantic_highlighting',
      type: 'bool',
      provider: lspSemanticHighlighting,
      getter: (ref) => ref.read(lspSemanticHighlighting),
      setter: (ref, v) =>
          ref.read(lspSemanticHighlighting.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.code_completion',
      type: 'bool',
      provider: lspCodeCompletion,
      getter: (ref) => ref.read(lspCodeCompletion),
      setter: (ref, v) =>
          ref.read(lspCodeCompletion.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.hover_info',
      type: 'bool',
      provider: lspHoverInfo,
      getter: (ref) => ref.read(lspHoverInfo),
      setter: (ref, v) => ref.read(lspHoverInfo.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.code_action',
      type: 'bool',
      provider: lspCodeAction,
      getter: (ref) => ref.read(lspCodeAction),
      setter: (ref, v) => ref.read(lspCodeAction.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.signature_help',
      type: 'bool',
      provider: lspSignatureHelp,
      getter: (ref) => ref.read(lspSignatureHelp),
      setter: (ref, v) => ref.read(lspSignatureHelp.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.document_color',
      type: 'bool',
      provider: lspDocumentColor,
      getter: (ref) => ref.read(lspDocumentColor),
      setter: (ref, v) => ref.read(lspDocumentColor.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.document_highlight',
      type: 'bool',
      provider: lspDocumentHighlight,
      getter: (ref) => ref.read(lspDocumentHighlight),
      setter: (ref, v) =>
          ref.read(lspDocumentHighlight.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.code_folding',
      type: 'bool',
      provider: lspCodeFolding,
      getter: (ref) => ref.read(lspCodeFolding),
    ...
    _SettingEntry(
      ...
      getter: (ref) => ref.read(lspGoToDefinition),
      setter: (ref, v) =>
          ref.read(lspGoToDefinition.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'lsp.rename',
      type: 'bool',
      provider: lspRename,
      getter: (ref) => ref.read(lspRename),
    ...
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(chineseToUnicodeConversion.notifier).state = v == true,
    ),
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(enableSignalDetection.notifier).state = v == true,
    ),
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(uploadConfirmStyleProvider.notifier).state = v.toString(),
    ),
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(confirmShortcutProvider.notifier).state = v.toString(),
    ),
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(cancelShortcutProvider.notifier).state = v.toString(),
    ),
    _SettingEntry(
      name: 'webrepl.host',
      type: 'string',
    ...
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(webReplPort.notifier).state = (v as num).toInt(),
    ),
    _SettingEntry(
      ...
      setter: (ref, v) =>
          ref.read(webReplPassword.notifier).state = v.toString(),
    ),
    _SettingEntry(
      name: 'serial.default_baud_rate',
      type: 'int',
      provider: serialDefaultBaudRate,
      getter: (ref) => ref.read(serialDefaultBaudRate),
      setter: (ref, v) {
    ...
    _SettingEntry(
      ...
      type: 'bool',
      provider: serialAutoReconnect,
      getter: (ref) => ref.read(serialAutoReconnect),
      setter: (ref, v) {
        final value = v == true;
    ...
    _SettingEntry(
      name: 'terminal.font_family',
      type: 'string',
      provider: terminalFontFamily,
      getter: (ref) => ref.read(terminalFontFamily),
      setter: (ref, v) =>
          ref.read(terminalFontFamily.notifier).state = v.toString(),
    ),
    _SettingEntry(
      name: 'terminal.font_size',
      type: 'double',
      provider: terminalFontSize,
      getter: (ref) => ref.read(terminalFontSize),
      setter: (ref, v) =>
          ref.read(terminalFontSize.notifier).state = (v as num).toDouble(),
    ),
    _SettingEntry(
      name: 'terminal.line_height',
      type: 'double',
      provider: terminalLineHeight,
      getter: (ref) => ref.read(terminalLineHeight),
      setter: (ref, v) =>
    ...
    _SettingEntry(
      ...
      getter: (ref) => ref.read(microPythonStubsEnabled),
      setter: (ref, v) =>
          ref.read(microPythonStubsEnabled.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'micropython.stubs.auto_detect_layers',
      type: 'bool',
      provider: microPythonStubsAutoDetectLayers,
      getter: (ref) => ref.read(microPythonStubsAutoDetectLayers),
      setter: (ref, v) =>
          ref.read(microPythonStubsAutoDetectLayers.notifier).state = v == true,
    ),
    _SettingEntry(
      name: 'micropython.stubs.layers',
      type: 'list',
      provider: microPythonStubsLayers,
      getter: (ref) => ref
      ...
      setter: (ref, v) {
        ...
        ref.read(microPythonStubsLayers.notifier).state = list
            .whereType<Map>()
            .map(
              (item) => MicroPythonStubsLayer.fromJson(
    ...
    _SettingEntry(
      name: 'micropython.stubs.extra_paths',
      type: 'list',
      provider: microPythonStubsExtraPaths,
      getter: (ref) => ref.read(microPythonStubsExtraPaths),
      setter: (ref, v) {
        final list = v is List ? v : const [];
        ref.read(microPythonStubsExtraPaths.notifier).state = list
